# Database is from : https://www.kaggle.com/datasets/kutaykutlu/forest-fire
...
train = training_datagenerator.flow_from_directory(
    '/Users/cristiandumbravanu/Desktop/Artificial Intelligence/CourseWork/Database/Training Data',
    target_size=(256, 256),
    color_mode='rgb',
    class_mode='binary',
...
# Add third layer
# cnn.add(tf.keras.layer=s.Conv2D(filters=256, kernel_size=3, padding='same', activation='relu'))
cnn.add(tf.keras.layers.MaxPool2D(pool_size=2))
